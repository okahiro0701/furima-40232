  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録出来ない時' do
      ...
      it 'passwordが全角だと登録できない' do
        @user.password = 'Aあああああ'
        @user.password_confirmation = 'Aあああああ'
        @user.valid?
        expect(@user.errors.full_messages).to include("Password は半角英数字の混合である必要があります")
      end
      ...
      it 'first_nameが半角では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First name は全角で必ず入力する必要があります")
      end
      ...
      it 'family_nameが半角では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Family name は全角で必ず入力する必要があります")
      end
      ...
      it 'first_name_kanaが半角では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First name kana は全角のカタカナで必ず入力する必要があります")
      end
      ...
      it 'family_name_kanaが半角では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Family name kana は全角のカタカナで必ず入力する必要があります")
      end
